...
let lightPoint = new THREE.PointLight(0xffffff,1)
lightPoint.position.set(-0.8,4.6,0)
scene.add(lightPoint)
scene.add(new THREE.PointLightHelper(lightPoint,0.08,0xffffff))

let lightPoint2 = new THREE.PointLight(0xffffff,1)
lightPoint2.position.set(-0.8,3.1,0)
scene.add(lightPoint2)
scene.add(new THREE.PointLightHelper(lightPoint2,0.08,0xffffff))
...
let lightPoint3 = new THREE.PointLight(0xffffff,1)
lightPoint3.position.set(-0.8,1.3,0)
scene.add(lightPoint3)
scene.add(new THREE.PointLightHelper(lightPoint3,0.08,0xffffff))
...
let lightPoint4 = new THREE.PointLight(0xffffff,1)
lightPoint4.position.set(-0.8,-0.4,0)
scene.add(lightPoint4)
scene.add(new THREE.PointLightHelper(lightPoint4,0.08,0xffffff))
...
let lightPoint5 = new THREE.PointLight(0xffffff,1)
lightPoint5.position.set(-0.8,-1.9,0)
scene.add(lightPoint5)
scene.add(new THREE.PointLightHelper(lightPoint5,0.08,0xffffff))
...
let lightPoint6 = new THREE.PointLight(0xffffff,1)
lightPoint6.position.set(-0.8,-3.8,0)
scene.add(lightPoint6)
scene.add(new THREE.PointLightHelper(lightPoint6,0.08,0xffffff))
